...
public class SearchNearByPlaces extends AppCompatActivity implements OnMapReadyCallback,
                       ...
                       final String vicinity = response.body().getResults().get(i).getVicinity();
                        ...
                        googleMap.setOnInfoWindowClickListener(new GoogleMap.OnInfoWindowClickListener() {
                            ...
                            public void onInfoWindowClick(Marker arg0) {
                                Intent intent = new Intent(getBaseContext(), RestrorentActivity.class);
                              String place = placeName;
                                String vic = vicinity;
                                intent.putExtra("place", place);
                                intent.putExtra("vic", vic);
    ...
    public boolean onMarkerClick(final Marker marker) {
        ...
        {
            //handle click here
            Intent intent=new Intent(SearchNearByPlaces.this,RestrorentActivity.class);
            startActivity(intent);
        }
        return false;
    }
